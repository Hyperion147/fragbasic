...
,
  // Dysphoria Maki
  {
    ...
    glassSurfaceFinish: "coated",
    glassSurfaceFinishNotes:
      "Dysphoria describes Maki as premium tempered glass with an enhanced precision coating and an ultra-fine micro-texture.",
    coatingDurability: "The artwork and surface are protected beneath a thin coating; long-term wear data is not yet available.",
    base: "silicone",
    softness: "hard",
    sizes: [{ label: "XL", width: 490, height: 420, thickness: 3, unit: "mm" }],
    visuals: {
      defaultColorway: "maki",
      colorways: [{ name: "Maki", slug: "maki", color: "#392d4d", image: "/mousepads/glasspads/dysphoria-maki.jpeg", available: true }],
    },
    feel: {
      speed: 8,
      control: 5,
    ...
    environment: {
      humidityResistance: 3,
      sweatResistance: 9,
      dustHairResistance: 0,
      washable: true,
      notes: "Submitted community review reports excellent sweat resistance but poor humidity and dust/hair resistance.",
    },
    texture: { feel: "slightly-textured", skinComfort: 5, sleeveFriendly: true, noiseLevel: "medium" },
    recommendedFor: {
      games: ["apex", "overwatch", "general-fps"],
      aimStyles: ["tracking", "switching"],
      sensitivity: ["medium", "high"],
    },
    avoidIf: ["You want a low-maintenance glass pad", "You do not want to replace mouse skates frequently"],
    price: { inr: 8000 },
    availability: { global: true, india: "limited", notes: "Community submission marked India availability as coming soon." },
    includedAccessories: ["Product card", "Microfiber cloth"],
    images: { main: "/mousepads/glasspads/dysphoria-maki.jpeg" },
    personal: {
      owned: false,
      tested: false,
      notes: "raywinhmm's submitted review calls Maki a very skate-hungry pad.",
      pros: ["Fast glass glide", "Excellent sleeve compatibility", "Strong sweat resistance"],
      cons: ["Very poor dust/hair resistance in the submission", "Can be demanding on mouse skates", "Low reported humidity resistance"],
    },
    communityConsensus: {
      summary: "Dysphoria Maki is a coated, speed-oriented glass pad with a smooth micro-fine surface and a pressure-control character. This entry reflects raywinhmm's submitted ratings.",
      commonComparisons: ["Dysphoria Sayo", "Dysphoria Rin", "speed glass pads"],
      strengths: ["Fast initial glide", "Smooth surface", "Sleeve friendly"],
      weaknesses: ["Skate hungry", "Debris can be an issue", "Limited India availability"],
    },
    sources: [
      { label: "raywinhmm community review submitted June 27, 2026", type: "personal" },
      { label: "Respawn Gaming Tech Dysphoria Maki product page", type: "store", url: "https://www.respawngt.com/products/dysphoria-maki-glass-mousepad" },
    ],
  },

  // Yuki Aim Monokuro
  {
    id: "yuki-aim-monokuro",
    slug: "yuki-aim-monokuro",
    brand: "Yuki Aim",
    name: "Monokuro",
    series: "Glass Mousepad",
    category: "glass",
    surface: "glass",
    glassSurfaceFinish: "unknown",
    glassSurfaceFinishNotes: "Yuki Aim specifies heat-strengthened aluminosilicate glass, without naming a surface coating.",
    base: "silicone",
    softness: "hard",
    sizes: [{ label: "XL", width: 490, height: 420, thickness: 3.1, unit: "mm" }],
    visuals: {
      defaultColorway: "monokuro",
      colorways: [{ name: "Monokuro", slug: "monokuro", color: "#ededed", image: "/mousepads/glasspads/yuki-aim-monokuro.png", available: true }],
    },
    feel: {
      speed: 6,
      control: 8,
    ...
    environment: {
      ...
      dustHairResistance: 7,
      washable: true,
      notes: "Submitted community review reports near-perfect consistency in humidity and sweat, with moderate dust/hair resistance.",
    },
    texture: { feel: "smooth", skinComfort: 9, sleeveFriendly: true, noiseLevel: "quiet" },
    recommendedFor: {
      games: ["valorant", "cs2", "general-fps"],
      aimStyles: ["precision", "micro-adjustments", "flicking"],
      sensitivity: ["low", "medium"],
    },
    avoidIf: ["You want maximum glass-pad speed", "You dislike a hard glass surface"],
    price: { inr: 12000 },
    availability: { global: true, india: "available", stores: ["Yuki Aim", "Waimers India"], notes: "Yuki Aim lists Waimers as its authorized Indian distributor; stock can vary." },
    images: { main: "/mousepads/glasspads/yuki-aim-monokuro.png" },
    personal: {
      owned: false,
      tested: false,
      notes: "raywinhmm's submitted review describes Monokuro as exceptionally smooth, close to cloth in feel, while attracting little dust.",
      pros: ["High control and stopping power for glass", "Very smooth surface", "Excellent humidity and sweat resistance"],
      cons: ["Premium pricing", "Hard glass surface is not for everyone"],
    },
    communityConsensus: {
      summary: "Yuki Aim Monokuro is a smooth, control-leaning glass option in this dataset, based on raywinhmm's submitted review. It combines a heat-strengthened glass top with a white silicone base and tapered edges.",
      commonComparisons: ["control glass pads", "Dysphoria Maki", "Dysphoria Rin"],
      strengths: ["Smooth and cloth-like feel for glass", "Strong control", "Excellent environmental consistency"],
      weaknesses: ["Premium cost", "Availability can fluctuate"],
    },
    sources: [
      { label: "raywinhmm community review submitted June 27, 2026", type: "personal" },
      { label: "Yuki Aim Monokuro official product page", type: "official", url: "https://yuki.gg/products/yuki-aim-monokuro-glass-mousepad" },
    ],
  },
  ...
  // Dysphoria Rin
  {
    ...
    surface: "glass",
    glassSurfaceFinish: "coated",
    glassSurfaceFinishNotes: "Arbiter Studio identifies Rin as a coated, speed-oriented textured glass surface.",
    coatingDurability: "Long-term coating wear data is not yet available.",
    base: "silicone",
    softness: "hard",
    sizes: [{ label: "XL", width: 500, height: 450, thickness: 1.5, unit: "mm" }],
    visuals: {
      defaultColorway: "black",
      colorways: [
        { name: "Black", slug: "black", color: "#111111", image: "/mousepads/glasspads/dysphoria-rin-black.webp", available: true },
        { name: "White", slug: "white", color: "#eeeeee", available: true },
      ],
    },
    feel: {
      speed: 10,
    ...
    environment: {
      ...
      dustHairResistance: 7,
      washable: true,
      notes: "The submitted review reports excellent humidity and sweat consistency with moderate debris resistance.",
    },
    texture: { feel: "rough", skinComfort: 2, sleeveFriendly: true, noiseLevel: "loud" },
    recommendedFor: {
      games: ["apex", "overwatch", "quake", "general-fps"],
      aimStyles: ["tracking", "switching", "micro-adjustments"],
      sensitivity: ["medium", "high"],
    },
    avoidIf: ["You want a smooth or quiet glass pad", "You rely exclusively on cloth-like friction"],
    price: { usd: 150 },
    availability: { global: true, india: "unknown", notes: "No India retailer was provided in the submission; international availability and stock vary." },
    includedAccessories: ["Manta Ray dot skates", "Cleaning cloth"],
    images: { main: "/mousepads/glasspads/dysphoria-rin-black.webp" },
    personal: {
      owned: false,
      tested: false,
      notes: "armenie's submitted review characterizes Rin as extremely fast, but more controllable than its speed suggests thanks to dynamic friction and a pushdown effect.",
      pros: ["Extreme speed", "High reported stopping power for its speed", "Excellent environmental consistency", "Sleeve friendly"],
      cons: ["Rougher physical texture", "Very fast glide is not for every player", "India availability is unclear"],
    },
    communityConsensus: {
      summary: "Dysphoria Rin is a very fast textured glass pad whose submitted review highlights unusually controllable stopping through dynamic friction and a pushdown effect.",
      commonComparisons: ["Dysphoria Maki", "Dysphoria Sayo", "speed glass pads"],
      strengths: ["Maximum speed", "Controlled pushdown behavior", "Strong humidity and sweat resistance"],
      weaknesses: ["Rougher texture", "High-speed learning curve", "Unclear India availability"],
    },
    sources: [
      { label: "armenie community review submitted June 27, 2026", type: "personal" },
      { label: "Arbiter Studio Dysphoria Rin official product page", type: "official", url: "https://arbiterstudio.com/products/dysphoria-rin-glass-pad" },
    ],
  }
];
