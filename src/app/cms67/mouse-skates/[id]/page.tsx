...
import { useAdminAccessory, useDeleteAccessory, useUpdateAccessory } from "@/features/admin/accessory-hooks";

export default function EditMouseSkatePage() {
  const { id } = useParams<{ id: string }>(); const router = useRouter(); const me = useAdminMe(); const query = useAdminAccessory(id); const update = useUpdateAccessory(id); const remove = useDeleteAccessory();
