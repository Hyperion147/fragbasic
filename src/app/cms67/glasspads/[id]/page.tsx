...
import { useAdminGlasspad, useDeleteGlasspad, useUpdateGlasspad } from "@/features/admin/glasspad-hooks";

export default function EditGlasspadPage() {
  const { id } = useParams<{ id: string }>(); const router = useRouter(); const me = useAdminMe(); const query = useAdminGlasspad(id); const update = useUpdateGlasspad(id); const remove = useDeleteGlasspad();
