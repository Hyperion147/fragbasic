        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 md:grid-cols-[1.1fr_0.9fr] md:px-8 md:py-20">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-base leading-7 text-muted-foreground md:text-lg">
              A feel-first breakdown of speed, control, stopping power,
              humidity resistance, surface texture, and competitive FPS fit.
            </p>
          ...
          <Card className="overflow-hidden border-border bg-card">
            <div className="aspect-[16/10] border-b border-border bg-secondary" />

            <div className="grid grid-cols-3 gap-2 p-4">
              <HeroStat label="Speed" value={pad.feel.speed} />
              <HeroStat label="Control" value={pad.feel.control} />
              <HeroStat label="Stop" value={pad.feel.stoppingPower} />
            </div>
          </Card>
        </div>
      </section>
