    ...
    <Card className="border-border bg-card p-5 md:p-6">
      <div className="mb-6">
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
          A 1-10 profile for speed, control, stopping power, static friction,
          dynamic glide, and micro-adjustment freedom.
        </p>
      </div>
      ...
      >
        ...
        <Radar dataKey="value" variant="filled" fillOpacity={0.24} isClickable>
