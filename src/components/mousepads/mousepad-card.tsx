...
function FeaturedMousepadCard({ pad }: { pad: Mousepad }) {
    return (
        <Link href={`/mousepads/${pad.slug}`} className="group block">
            <Card className="overflow-hidden border-violet-400/40 bg-card/95 p-4 ring-2 ring-violet-400/90 ring-offset-2 ring-offset-background transition-shadow hover:shadow-lg hover:shadow-violet-500/10 sm:p-5">
