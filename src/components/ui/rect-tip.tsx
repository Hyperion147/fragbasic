      ...
      <AnimatePresence>
        {isHovered && (
          <motion.a
            ...
            className={`absolute -top-18 left-1/2 z-40 flex -translate-x-1/2 gap-2 rounded-md border border-gray-300 bg-background p-2 text-xs backdrop-blur-2xl ${width} ${height}`}
