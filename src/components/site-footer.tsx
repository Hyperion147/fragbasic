        ...
        <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
            ...
            <div className="space-y-6">
              ...
              <div className="max-w-2xl space-y-4">
                <p className="text-sm leading-7 text-muted-foreground sm:text-base">
                  Browse mousepad data, compare matchups, and jump into the real
                  finder when you want a recommendation instead of a guess.
                </p>
          ...
          <FooterReveal delay={0.16} reduceMotion={reduceMotion}>
            <div className="grid gap-8 sm:grid-cols-3">
              <FooterLinkGroup title="Explore" links={primaryLinks} />
              <FooterLinkGroup title="Browse" links={browseLinks} />
              <FooterLinkGroup title="Brands" links={brandLinks} />
            </div>
          </FooterReveal>
        </div>

        <FooterReveal delay={0.22} reduceMotion={reduceMotion}>
          <div className="mt-12 flex flex-col gap-3 text-sm text-muted-foreground md:flex-row md:items-center md:justify-between">
            <p>FRAGBASIC.FUN helps players research mousepads faster.</p>
            <div className="flex flex-wrap items-center gap-x-5 gap-y-2">
              <Link href="/mousepads" className="transition-opacity hover:opacity-70">
                Mousepads
              </Link>
              <Link href="/mousepads/finder" className="transition-opacity hover:opacity-70">
                Finder
              </Link>
              <Link href="/mousepads/compare" className="transition-opacity hover:opacity-70">
                Compare
              </Link>
              <Link href="/mousepads/brands" className="transition-opacity hover:opacity-70">
                Brands
              </Link>
            </div>
          </div>
